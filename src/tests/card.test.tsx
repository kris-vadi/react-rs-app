...
describe('Tests for the Card component', () => {
  it('Ensure that the card component renders the relevant card data', async () => {
    ...
    // expect(await screen.findByText(/gender:/i)).toBeTruthy();
    // expect(await screen.findByText(/Male/i)).toBeTruthy();
    // expect(await screen.findByText(/nationality:/i)).toBeTruthy();
    // expect(await screen.findByText(/English/i)).toBeTruthy();
    // expect(await screen.findByText(/blood status:/i)).toBeTruthy();
    // expect(await screen.findByText(/Half-blood/i)).toBeTruthy();
    // expect(await screen.findByText(/species:/i)).toBeTruthy();
